...
"    highp float NdotN2      = (dot(normals, normals2));                                                                                     \n"
"    highp float NdotN3      = (dot(normals, normals3));                                                                                     \n"
"    highp float NdotN4      = (dot(normals, normals4));                                                                                     \n"
...
"    originalPixel        *=  originalPixel * NdotN2 * distance * 100.0;                                             \n"

"    distance              =  length(depth - depth3);                                                               \n"
"    originalPixel        *=  originalPixel * NdotN3 * distance * 100.0;                                             \n"

"    distance              =  length(depth - depth4);                                                               \n"
"    originalPixel        *=  originalPixel * NdotN4 * distance * 100.0;                                             \n"
